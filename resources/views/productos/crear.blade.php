      ...
      <div class="col-md-12">
         <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
               <a href="{{ route('productos') }}" class="btn btn-primary btn-sm">Volver a menú principal</a>
            ...
            <div class="card-body">
               ...
               <form method="POST" action="/nuevo" >
                  ...
                  <div class="row">
                     ...
                     <div class="form-group col-3">
                        <input   type="date" name="FechaCaducidad" placeholder="FechaCaducidad" class="form-control mb-2" id="FechaCaducidad" required title="Fecha Caducidad"/>
                     </div>
                  </div>
                  <div class="row">
                     <div class="form-group col-3">
                        <input  type="text" name="valor" id="valor" placeholder="Precio Unitario" class="form-control mb-2" required min="1" maxlength="11"/>
                     </div>
                     <div class="form-group col-3">
                        <input  type="text" name="ubicacion" id="Ubicacion" placeholder="Ubicacion" class="form-control  mb-2" required min="1" maxlength="30"/>
                     </div>
                  </div>
                  <div class="field_wrapper row">
                     <div class="input-group">
                        <input type="text" class="form-control mb-2 col-md-11" name="cantidades[]" placeholder="Caracteristicas Producto" required min="1" maxlength="533"/>
...
<div id="modal" class="modal-dialog modal-dialog-centered" height="450px" width="450px">
   <form method="POST" action="/productos/insertar_categoria" id="ex1" class="modal" style="text-align:center;">
      @csrf
